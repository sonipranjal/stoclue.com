              ...
              <div className="relative flex items-center justify-between p-5 bg-white rounded-sm">
                <div className="pr-4">
                  <h6 className="mb-2 font-semibold leading-5 text-yellow-500">
                    Read our financial newsletters.
                  </h6>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2">
              ...
              <a
                ...
                className="inline-flex items-center p-3 text-lg font-semibold text-white transition duration-200 ease-in-out transform rounded-lg bg-gradient-to-r from-yellow-300 to-yellow-500 focus:outline-none motion-reduce:transform-none hover:scale-110"
              >
                Learn more
              </a>
            </div>
