const Terms = () => {
  return (
    <div>
      ...
      <p>Welcome to stoclue!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of stoclue's Website, located at https://stoclue.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use stoclue if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing stoclue, you agreed to use
        cookies in agreement with the stoclue's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, stoclue and/or its licensors own the
        intellectual property rights for all material on stoclue. All
        intellectual property rights are reserved. You may access this from
        stoclue for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from stoclue</li>
        <li>Sell, rent or sub-license material from stoclue</li>
        <li>Reproduce, duplicate or copy material from stoclue</li>
        <li>Redistribute content from stoclue</li>
      </ul>
      ...
      <p>
        ...
        stoclue does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of stoclue,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, stoclue shall not be liable for the
      ...
      <p>
        stoclue reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant stoclue a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of stoclue; and (d) the link is in
      ...
      <p>
        ...
        e-mail to stoclue. Please include your name, your organization name,
      ...
      <p>
        No use of stoclue's logo or other artwork will be allowed for linking
