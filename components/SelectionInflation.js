...
const SelectionInflation = ({ values, setValues }) => {
          ...
          {open && (
            <div className="absolute mt-1 w-full z-10 rounded-md bg-white shadow-lg">
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    <span className="ml-3 block font-normal truncate">Yes</span>
                  </div>
                </li>
              </ul>
              <ul
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    <span className="ml-3 block font-normal truncate">No</span>
                  </div>
                </li>
              </ul>
            </div>
...
export default SelectionInflation;
